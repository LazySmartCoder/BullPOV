"""
Django settings for BullPOVPortal project.
...
INSTALLED_APPS = [
    ...
    'BullPOVApp.apps.BullpovappConfig',
    'BullPOVAdmin.apps.BullpovadminConfig',
]
...
MIDDLEWARE = [
    ...
    'BullPOVApp.OTPMiddleware.OTPMiddleware'
]

ROOT_URLCONF = 'BullPOVPortal.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'BullPOVApp.context_processors.global_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'BullPOVPortal.wsgi.application'
